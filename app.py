...
st.set_page_config(page_title="Evaluación de Sitios Públicos", layout="wide")

# Logo (opcional)
st.image("NetHome.jpg", width=250)  # Asegúrate de tener el archivo en el mismo directorio

# Título y descripción
st.title("Primer evaluación de Sitios Públicos con Conectividad")
st.markdown("""
...
with st.expander("Ver leyenda del mapa"):
    if capa_sel == 'Calificación':
        st.markdown("- 🟢 Calificación ≥ 7\n- 🟠 Calificación = 5\n- 🔴 Calificación < 5")
    elif capa_sel == 'Velocidad de Bajada':
        st.markdown("- 🔵 Tamaño proporcional a velocidad de bajada")
    elif capa_sel == 'Velocidad de Subida':
        st.markdown("- 🟣 Tamaño proporcional a velocidad de subida")
